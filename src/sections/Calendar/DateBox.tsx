...
export default function DateBox(props: emptyT | dayT) {
  ...
  return (
    <ContextMenu>
      <ContextMenuTrigger>
        <div className="w-full h-full flex flex-col duration-150 group cursor-default justify-between hover:bg-[#070707] items-start bg-background md:p-2 sm:p-1.5 xs:p-1 p-0.5">
